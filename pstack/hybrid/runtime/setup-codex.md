---
name: setup-pstack
description: Configure hstack model roles in Codex. Use for setup-pstack, configure hstack or pstack models, or changing model choices.
---

# Set up hstack in Codex

Read [the Codex runtime adapter](../../references/codex-runtime.md). This native setup replaces the upstream Cursor rule workflow. Keep the inherited `setup-pstack` command and `pstack-models.json` preference path so existing preferences continue to work.
